          ...
          children: [
            Row(
              ...
              children: [
                InkWell(
                  onTap: () {
                    deleteaccount(context, widget.themeData,widget.accitem);
                  },
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Icon(CupertinoIcons.delete_solid,color: Colors.white,size: 30,),
                          Text('حذف',style: widget.themeData.textTheme.headline3!.copyWith(color: Colors.white,fontSize: 14),)
                        ],
                      ),
                    ),
                  ),
...
deleteaccount(BuildContext context, ThemeData themeData,Accounts accitem) {
